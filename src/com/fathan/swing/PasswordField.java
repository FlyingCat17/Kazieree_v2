...
public class PasswordField extends JPasswordField {
    ...
    public PasswordField() {
        ...
        eye = new ImageIcon(getClass().getResource("/com/fathan/swing/eye.png")).getImage();
        eye_hide = new ImageIcon(getClass().getResource("/com/fathan/swing/eye_hide.png")).getImage();
