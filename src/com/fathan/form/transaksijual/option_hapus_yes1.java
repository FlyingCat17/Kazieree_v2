 ...
 * @author Fathan
 */
public class option_hapus_yes1 extends javax.swing.JDialog {

    /**
     * Creates new form Tambah_Produk
     */
    public option_hapus_yes1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(option_hapus_yes1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                option_hapus_yes1 dialog = new option_hapus_yes1(new javax.swing.JFrame(), true);
