...
//    }
    ...
    private void button2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button2ActionPerformed
        try {
            String sql = "DELETE FROM temp_jual WHERE temp_jual.kode_produk = '" + new com.fathan.form.transaksijual.getKode_Produk().getKode_produk() + "'";
            java.sql.Connection con = (Connection) configdb.GetConnection();
            java.sql.Statement st = con.createStatement();
            st.execute(sql);
            JOptionPane.showMessageDialog(this, "Berhasil Hapus : " + new com.fathan.form.transaksijual.getKode_Produk().getKode_produk());
            for (double i = 1.0; i >= 0.1; i = i - 0.2) {
                String val = i + "";
                float f = Float.valueOf(val);
                this.setOpacity(f);
            ...
            new com.fathan.form.transaksijual.option_hapus_yes(new com.fathan.form.transaksijual.transaksi_jual(), true).setVisible(true);
            new com.fathan.form.transaksijual.getKode_Produk().setOpsi_hapus_yes(true);
        } catch (Exception e) {
