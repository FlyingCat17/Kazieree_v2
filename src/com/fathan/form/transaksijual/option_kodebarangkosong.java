 ...
 * @author Fathan
 */
public class option_kodebarangkosong extends javax.swing.JDialog {

    /**
     * Creates new form Tambah_Produk
     */
    public option_kodebarangkosong(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Harap Pilih Salah Satu Produk !");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(option_kodebarangkosong.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                option_kodebarangkosong dialog = new option_kodebarangkosong(new javax.swing.JFrame(), true);
