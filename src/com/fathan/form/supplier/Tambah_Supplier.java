...
public class Tambah_Supplier extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        label_success.setForeground(new java.awt.Color(0, 255, 0));
        label_success.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        label_success.setText("Data Berhasil Ditambahkan !");
        panelBordeer1.add(label_success, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 320, 390, 50));
...
//    }
    private void button2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button2ActionPerformed
        ...
        if (ks.isEmpty()) {
            ...
            try {
                String sql = "INSERT INTO `pemasok`(`kode_pemasok`, `nama_pemasok`, `nama_usaha`, `no_telepon`, `alamat`)"
                        + " VALUES ('" + ks + "','" + ns + "','" + nu + "','" + nt + "','" + a + "')";
