...
public class option_hapus extends javax.swing.JDialog {
    ...
    public void setNamaProduk() {
        jLabel4.setText("Produk : " + new com.fathan.form.supplier.getdataSupplier().getNama_supplier());
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Yakin Ingin Menghapus Data Supplier Ini?");
    ...
    private void button2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button2ActionPerformed
        try {
            String sql = "DELETE FROM pemasok WHERE kode_pemasok = '" + new com.fathan.form.supplier.getdataSupplier().getKode_supplier()+ "'";
            ...
            new com.fathan.form.supplier.option_hapus_yes(new com.fathan.form.supplier.supplier(), true).setVisible(true);
        } catch (Exception e) {
            System.err.println("Delete Supplier : " + e.getMessage());
        }
