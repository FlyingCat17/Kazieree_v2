...
public class supplier extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        panelRound1.add(field_cari, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 0, 730, 40));
    ...
    private void button2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button2ActionPerformed
        new com.fathan.form.supplier.Tambah_Supplier(this, true).setVisible(true);
        loadTableSupplier();
    ...
    private void tableDark2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableDark2MouseClicked
        if (evt.getClickCount() == 1) {
            ...
            new com.fathan.form.supplier.getdataSupplier().setKode_supplier(tableDark2.getValueAt(i, 0).toString());
            System.out.println("Kode Supplier yang didapat : " + new com.fathan.form.supplier.getdataSupplier().getKode_supplier());
            label_emptyData.setVisible(false);
            new com.fathan.form.supplier.getdataSupplier().setNama_supplier(tableDark2.getValueAt(i, 1).toString());
        }
    }//GEN-LAST:event_tableDark2MouseClicked

    public String kategori = null;
    private void button3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button3ActionPerformed
        if (new com.fathan.form.supplier.getdataSupplier().getKode_supplier() == null) {
            System.out.println(new com.fathan.form.supplier.getdataSupplier());
            label_emptyData.setVisible(true);
            label_emptyData.setText("Harap Pilih Salah Satu Supplier !");
        } else {
            new com.fathan.form.supplier.Ubah_Supplier(this, true).setVisible(true);
            loadTableSupplier();
        }
    ...
    private void button1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button1ActionPerformed
        ...
        } else if (new com.fathan.form.supplier.getdataSupplier().getKode_supplier() == null) {
            label_emptyData.setVisible(true);
            label_emptyData.setText("Harap Pilih Salah Satu Supplier !");
        } else {
            new com.fathan.form.supplier.option_hapus(this, true).setVisible(true);
            loadTableSupplier();
        }
    }//GEN-LAST:event_button1ActionPerformed

    public void cariDataSupplier(String key) {
        try {
            Object[] judul_kolom = {"Kode Supplier", "Nama Supplier", "Nama Usaha", "Nomor Telepon", "Alamat Usaha"};
            DefaultTableModel model = new DefaultTableModel(null, judul_kolom);
            tableDark2.setModel(model);
            java.sql.Connection con = (Connection) configdb.GetConnection();
            java.sql.Statement st = con.createStatement();
            ...
            java.sql.ResultSet rs = st.executeQuery("SELECT * FROM pemasok WHERE pemasok.nama_pemasok LIKE '%"+key+"%' "
                    + "OR pemasok.nama_usaha LIKE '%"+key+"%'");
            while (rs.next()) {
                Object[] data = {
                    rs.getString(1),
                    rs.getString(2),
            ...
            tableDark2.getColumnModel().getColumn(1).setPreferredWidth(100);
            tableDark2.getColumnModel().getColumn(2).setPreferredWidth(20);
            tableDark2.getColumnModel().getColumn(3).setPreferredWidth(1);
            tableDark2.getColumnModel().getColumn(4).setPreferredWidth(300);
        } catch (Exception e) {
            System.err.println("Cari Data : " + e.getMessage());
        }
    }
