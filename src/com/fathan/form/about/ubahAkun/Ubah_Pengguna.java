...
import com.fathan.form.pengguna.*;
...
public class Ubah_Pengguna extends javax.swing.JDialog {
    ...
    public Ubah_Pengguna(java.awt.Frame parent, boolean modal) {
        ...
        field_ip.setText(new com.fathan.user.user().getId_pengguna());
        loadDataPenggunaa();
    ...
    private void initComponents() {
        ...
        button6 = new com.fathan.form.about.Button();
        ...
        button5 = new com.fathan.form.about.Button();
        ...
        button3.setText("UBAH KATA SANDI");
        ...
        panelBordeer1.add(button3, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 370, 150, 40));
        ...
        button6.setText("UBAH KATA SANDI");
        button6.setFont(new java.awt.Font("Montserrat ExtraBold", 0, 13)); // NOI18N
        button6.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                button6ActionPerformed(evt);
            }
        });
        panelShadow4.add(button6, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 180, 30));

        panelBordeer1.add(panelShadow4, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 430, 200, 50));
        ...
        panelShadow3.add(button4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 180, 30));

        panelBordeer1.add(panelShadow3, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 430, 200, 50));
        ...
        button5.setBackground(new java.awt.Color(19, 179, 200));
        button5.setForeground(new java.awt.Color(255, 255, 255));
        button5.setText("SIMPAN");
        button5.setFont(new java.awt.Font("Montserrat ExtraBold", 0, 13)); // NOI18N
        button5.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                button5ActionPerformed(evt);
            }
        });
        panelShadow2.add(button5, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 180, 30));

        panelBordeer1.add(panelShadow2, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 430, 200, 50));
    ...
    public void loadDataPenggunaa() {
        try {
            String sql = "SELECT pengguna.id_pengguna, pengguna.nama_pengguna, detail_pengguna.nama_lengkap, detail_pengguna.jenis_kelamin, "
                    ...
                    + "WHERE pengguna.id_pengguna = '" + new com.fathan.user.user().getId_pengguna() + "'";
        ...
        if (username_similar = false) {
            ...
            try {
                ...
                String update_detail_pengguna = "UPDATE `detail_pengguna` SET "
                        ...
                        + "WHERE detail_pengguna.id_pengguna = '" + new com.fathan.user.user().getId_pengguna() + "';";
                java.sql.Connection con = (Connection) configdb.GetConnection();
                java.sql.Statement st = con.createStatement();
    ...
    private void field_usKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_field_usKeyPressed
        if (evt.isControlDown() && evt.getKeyCode() == KeyEvent.VK_V) {
            System.out.println("Disabled");
            evt.consume();
        }
    }//GEN-LAST:event_field_usKeyPressed

    private void field_nlKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_field_nlKeyPressed
        if (evt.isControlDown() && evt.getKeyCode() == KeyEvent.VK_V) {
            System.out.println("Disabled");
            evt.consume();
        }
    }//GEN-LAST:event_field_nlKeyPressed
    ...
    private void field_aKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_field_aKeyPressed
        if (evt.isControlDown() && evt.getKeyCode() == KeyEvent.VK_V) {
            System.out.println("Disabled");
            evt.consume();
        }
    }//GEN-LAST:event_field_aKeyPressed

    private void button6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button6ActionPerformed
        new com.fathan.form.about.ubahAkun.ubah_Katasandi(new com.fathan.form.beranda.beranda(), true).setVisible(true);
    ...
    private com.fathan.form.about.Button button5;
    private com.fathan.form.about.Button button6;
