 ...
 * @author Fathan
 */
public class Cari_Supplier extends javax.swing.JDialog {

    /**
     * Creates new form Tambah_Produk
     */
    public Cari_Supplier(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        label_warning_kp.setText("Harap Pilih Supplier !");
    ...
    public void cariData(String key) {
        try {
            ...
            java.sql.ResultSet rs = st.executeQuery("SELECT produk.kode_produk, produk.nama_produk, kategori.nama_kategori, produk.satuan, "
                    + "produk.harga_beli, produk.harga_beli\n"
                    + "FROM produk\n"
                    + "JOIN kategori\n"
    ...
    public void loadTablePemasok() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                tableDark2.getColumnModel().getColumn(0).setPreferredWidth(10);
                tableDark2.getColumnModel().getColumn(1).setPreferredWidth(150);
                tableDark2.getColumnModel().getColumn(2).setPreferredWidth(1);
                tableDark2.getColumnModel().getColumn(3).setPreferredWidth(1);
    ...
    private void button1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button1ActionPerformed
        new com.fathan.form.transaksibeli.getKode_Produk().setKode_supplier("-");
        new com.fathan.form.transaksibeli.getKode_Produk().setNama_supplier("-");
    ...
    private void button2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button2ActionPerformed
        if (new com.fathan.form.transaksibeli.getKode_Produk().getKode_supplier() == null) {
            label_warning_kp.setVisible(true);
        } else {
            new com.fathan.form.transaksibeli.Tambah_Produk(new com.fathan.form.transaksibeli.transaksi_beli(), true).field_kp.setText(new com.fathan.form.transaksibeli.getKode_Produk().getKode_supplier());
            for (double i = 1.0; i >= 0.1; i = i - 0.25) {
                String val = i + "";
                float f = Float.valueOf(val);
                this.setOpacity(f);
    ...
    private void tableDark2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableDark2MouseClicked
        if (evt.getClickCount() == 1) {
            ...
            new com.fathan.form.transaksibeli.getKode_Produk().setKode_supplier(tableDark2.getValueAt(i, 0).toString());
            System.out.println("Pilih dari Cari Supplier {Kode Supplier} : " + new com.fathan.form.transaksibeli.getKode_Produk().getKode_supplier());
            new com.fathan.form.transaksibeli.getKode_Produk().setNama_supplier(tableDark2.getValueAt(i, 1).toString());
            System.out.println("Pilih dari Cari Supplier {Kode Supplier} : " + new com.fathan.form.transaksibeli.getKode_Produk().getNama_supplier());
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cari_Supplier.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Cari_Supplier dialog = new Cari_Supplier(new javax.swing.JFrame(), true);
