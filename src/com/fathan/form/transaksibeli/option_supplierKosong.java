 ...
 * @author Fathan
 */
public class option_supplierKosong extends javax.swing.JDialog {

    /**
     * Creates new form Tambah_Produk
     */
    public option_supplierKosong(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Tidak ada Supplier yang ditambahkan !");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(option_supplierKosong.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                option_supplierKosong dialog = new option_supplierKosong(new javax.swing.JFrame(), true);
