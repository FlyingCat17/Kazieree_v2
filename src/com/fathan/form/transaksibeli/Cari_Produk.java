...
public class Cari_Produk extends javax.swing.JDialog {
    ...
    private void button2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button2ActionPerformed
        if (new com.fathan.form.transaksibeli.getKode_Produk().getKode_produk() == null) {
            ...
            new com.fathan.form.transaksibeli.Tambah_Produk(new com.fathan.form.transaksibeli.transaksi_beli(), true).field_kp.setText(new com.fathan.form.transaksibeli.getKode_Produk().getKode_produk());
            for (double i = 1.0; i >= 0.1; i = i - 0.25) {
                String val = i + "";
                float f = Float.valueOf(val);
                this.setOpacity(f);
    ...
    private void tableDark2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableDark2MouseClicked
        if (evt.getClickCount() == 1) {
            ...
            System.out.println("Pilih dari Cari Produk {Kode Produk} : " + new com.fathan.form.transaksibeli.getKode_Produk().getKode_produk());
        }
