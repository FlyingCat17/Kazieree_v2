 ...
 * @author Fathan
 */
public class option_hapus_yes extends javax.swing.JDialog {

    /**
     * Creates new form Tambah_Produk
     */
    public option_hapus_yes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(button1, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 240, 90, -1));
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/fathan/form/produk/icon_success.png"))); // NOI18N
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 60, 490, 120));
    ...
    private void button1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button1ActionPerformed
        ...
        new com.fathan.form.transaksibeli.getKode_Produk().setOpsi_hapus_yes(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(option_hapus_yes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                option_hapus_yes dialog = new option_hapus_yes(new javax.swing.JFrame(), true);
