...
public class Ubah_Produk extends javax.swing.JDialog {
    ...
    public Ubah_Produk(java.awt.Frame parent, boolean modal) {
        ...
        loadData();
        System.out.println("Kode Produk Yang Didapat \"Ubah_Produk_Beli\": " + new com.fathan.form.transaksibeli.getKode_Produk().getKode_produk());
    }
...
//        }
//    }
    com.fathan.form.transaksibeli.getKode_Produk k_p = new com.fathan.form.transaksibeli.getKode_Produk();
    public void loadData() {
        field_kp.setText(k_p.getKode_produk());
        try {
            String sql = "SELECT temp_beli.kode_produk, temp_beli.nama_produk, temp_beli.qty, temp_beli.harga_jual, produk.satuan"
                    + " FROM temp_beli JOIN produk ON temp_beli.kode_produk = produk.kode_produk WHERE temp_beli.kode_produk = '" + new com.fathan.form.transaksibeli.getKode_Produk().getKode_produk() + "'";
...
//            java.sql.ResultSet rs1 = st1.executeQuery(sql1);
            if (rs.next()) {
                System.out.println(rs.getString("nama_produk")+"_"+rs.getString("satuan")+"_"+rs.getString("harga_jual")+"_"+rs.getString("qty"));
                field_np.setText(rs.getString("nama_produk"));
                field_s.setText(rs.getString("satuan"));
                field_hp.setText(rs.getString("harga_jual"));
    ...
    private void initComponents() {
        ...
        panelBordeer2.add(field_kp, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 420, 40));
        ...
        panelBordeer1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 270, 190, -1));
        ...
        panelBordeer1.add(button3, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 370, 150, 40));
        ...
        panelBordeer1.add(button1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 370, 150, 40));
        ...
        panelBordeer1.add(button2, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 370, 150, 40));
...
//        }
    ...
    private void button1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button1ActionPerformed
        new com.fathan.form.transaksibeli.getKode_Produk().setKode_produk(null);
    ...
    private void button2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button2ActionPerformed
        if (field_jumlah.getText().isEmpty()) {
            ...
            try {
                String sql = "UPDATE temp_beli SET temp_beli.qty = temp_beli.qty - " + Integer.parseInt(field_jumlah.getText())
                        + " WHERE temp_beli.kode_produk = '" + k_p.getKode_produk() + "'";
                String sql1 = "UPDATE temp_beli SET temp_beli.qty = " + Integer.parseInt(field_jumlah.getText())
                        + " WHERE temp_beli.kode_produk = '" + k_p.getKode_produk() + "'";
...
//        }
    ...
    private void button3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button3ActionPerformed
        new com.fathan.form.transaksibeli.option_hapus(new com.fathan.form.transaksibeli.transaksi_beli(), true).setVisible(true);
        if (new com.fathan.form.transaksibeli.getKode_Produk().isOpsi_hapus_yes() == true) {
            for (double i = 1.0; i >= 0.1; i = i - 0.25) {
                String val = i + "";
                float f = Float.valueOf(val);
                this.setOpacity(f);
