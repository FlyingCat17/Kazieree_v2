...
public class option_hapus extends javax.swing.JDialog {
    ...
    private void button2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button2ActionPerformed
        try {
            String sql = "DELETE FROM produk WHERE kode_produk = '" + new com.fathan.form.produk.getdatabarang().getKode_produk() + "'";
            ...
            new com.fathan.form.produk.option_hapus_yes(new com.fathan.form.produk.produk(), true).setVisible(true);
        } catch (Exception e) {
        }
