...
public class pengguna extends javax.swing.JFrame {
    ...
    public void cariDataPengguna(String key) {
        try {
            Object[] judul_kolom = {"ID Pengguna", "Username", "Nama Lengkap", "Role/Batasan", "Status"};
            ...
            java.sql.ResultSet rs = st.executeQuery("SELECT pengguna.id_pengguna, pengguna.nama_pengguna, detail_pengguna.nama_lengkap, pengguna.role, pengguna.status \n"
                    + "FROM pengguna\n"
                    + "JOIN detail_pengguna\n"
                    + "ON pengguna.id_pengguna = detail_pengguna.id_pengguna\n"
                    + "WHERE pengguna.nama_pengguna LIKE '%" + key + "%' "
                    + "OR detail_pengguna.nama_lengkap LIKE '%" + key + "%' "
                    + "OR pengguna.role LIKE '%" + key + "%'");
            while (rs.next()) {
                Object[] data = {
                ...
                model.addRow(data); 
                tableDark2.getColumnModel().getColumn(0).setPreferredWidth(1);
                tableDark2.getColumnModel().getColumn(1).setPreferredWidth(40);
                tableDark2.getColumnModel().getColumn(2).setPreferredWidth(600);
    ...
    public void loadTablePengguna() {
        DefaultTableModel model = new DefaultTableModel();
        model.addColumn("ID Pengguna");
        model.addColumn("Username");
        model.addColumn("Nama Lengkap");
        model.addColumn("Role/Batasan");
        model.addColumn("Status");
        tableDark2.setModel(model);
        try {
            String load = "SELECT pengguna.id_pengguna, pengguna.nama_pengguna, detail_pengguna.nama_lengkap, pengguna.role, pengguna.status \n"
                    + "FROM pengguna\n"
                    + "JOIN detail_pengguna\n"
                    + "ON pengguna.id_pengguna = detail_pengguna.id_pengguna\n"
                    + "ORDER BY pengguna.id_pengguna ASC;";
    ...
    private void initComponents() {
        ...
        panel_top1.add(label_emptyData, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 70, 610, 40));
        ...
        panelRound1.add(field_cari, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 0, 720, 40));

        panel_top1.add(panelRound1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 30, 820, 40));
    ...
    private void button2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button2ActionPerformed
        new com.fathan.form.pengguna.Tambah_Pengguna(this, true).setVisible(true);
        loadTablePengguna();
    ...
    private void tableDark2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableDark2MouseClicked
        if (evt.getClickCount() == 1) {
            ...
            new com.fathan.form.pengguna.getPengguna().setId_pengguna(tableDark2.getValueAt(i, 0).toString());
            System.out.println("ID PENGGUNA = " + new com.fathan.form.pengguna.getPengguna().getId_pengguna());
            label_emptyData.setVisible(false);
            label_emptyData.setText("Data Kosong!!");
        }
    ...
    private void button3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button3ActionPerformed
        if (new com.fathan.form.pengguna.getPengguna().getId_pengguna() == null) {
            label_emptyData.setVisible(true);
            label_emptyData.setText("Harap Pilih Salah Satu Pengguna !");
        } else {
            new com.fathan.form.pengguna.Ubah_Pengguna(this, true).setVisible(true);
            loadTablePengguna();
        }
    ...
    private void button1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button1ActionPerformed
        if (new com.fathan.form.pengguna.getPengguna().getId_pengguna() == null) {
            ...
            new com.fathan.form.pengguna.option_hapus(this, true).setVisible(true);
            loadTablePengguna();
        }
