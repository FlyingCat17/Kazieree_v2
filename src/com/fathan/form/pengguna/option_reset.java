 ...
 * @author Fathan
 */
public class option_reset extends javax.swing.JDialog {

    /**
     * Creates new form Tambah_Produk
     */
    public option_reset(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void setNamaProduk() {
        jLabel4.setText("Username : " + new com.fathan.form.pengguna.getPengguna().getNama_pengguna());
    }
    ...
    private void button1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button1ActionPerformed
        new com.fathan.form.pengguna.getPengguna().setNama_pengguna(null);
    ...
    private void button2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button2ActionPerformed
        try {
            ...
            new com.fathan.form.pengguna.option_reset_yes(new com.fathan.form.pengguna.pengguna(), true).setVisible(true);
        } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(option_reset.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                option_reset dialog = new option_reset(new javax.swing.JFrame(), true);
