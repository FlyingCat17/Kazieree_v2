 ...
 * @author Fathan
 */
public class option_reset_yes extends javax.swing.JDialog {

    /**
     * Creates new form Tambah_Produk
     */
    public option_reset_yes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Berhasil Direset !");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(option_reset_yes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                option_reset_yes dialog = new option_reset_yes(new javax.swing.JFrame(), true);
