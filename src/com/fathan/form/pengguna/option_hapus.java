...
public class option_hapus extends javax.swing.JDialog {
    ...
    public void setNamaProduk() {
        jLabel4.setText("ID Pengguna : " + new com.fathan.form.pengguna.getPengguna().getId_pengguna());
    }
    ...
    private void button2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button2ActionPerformed
        try {
            String sql = "DELETE FROM pengguna WHERE pengguna.id_pengguna = '"
                    + new com.fathan.form.pengguna.getPengguna().getId_pengguna() + "'";
            ...
            new com.fathan.form.pengguna.option_hapus_yes(new com.fathan.form.pengguna.pengguna(), true).setVisible(true);
        } catch (Exception e) {
